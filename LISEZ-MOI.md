# Livret d'accueil numérique — Le Clair-Obscur
...
1. Double-cliquez sur le raccourci **« Le Clair-Obscur »** (ou lancez `DEMARRER.ps1`).
   L'éditeur s'ouvre dans le navigateur (`http://localhost:4001`).
